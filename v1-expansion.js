(function () {
  ...
  var CONTRACT_TEMPLATES = [
    ...
    {slug:'record-run',title:'Record Run',goals:[2,6,11,16],objective:function(g){return 'Recover ' + g + ' world collectibles.';},metric:function(s){return (s.state.collectibles || []).length;},profession:'exploration'},
    ...
    {slug:'unmarked-paths',title:'Unmarked Paths',goals:[1,2,4,5],objective:function(g){return 'Reveal ' + g + ' hidden locations.';},metric:function(s){return (s.state.discoveredSecrets || []).length;},profession:'exploration'},
